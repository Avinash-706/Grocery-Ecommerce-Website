...
const NewsLetterBox = () => {
  ...
  return (
    <div className='text-center'>
      ...
      <p className='mt-3 text-gray-400'>Sign up for our newsletter and enjoy an exclusive 20% discount on your next order! Stay updated on the latest products, special deals, and more.</p>
